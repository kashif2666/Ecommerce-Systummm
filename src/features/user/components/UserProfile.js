...
export default function UserProfile() {
  ...
  const [showAddAddresForm, setShowAddAddresForm] = useState(false);
    ...
    <div>
      <div className="mx-auto mt-12 max-w-7xl bg-white px-4 sm:px-6 lg:px-8">
        <div className=" border-t border-gray-200 px-4 py-6 sm:px-6">
          <h1 className="text-5xl my-5 font-bold tracking-tight text-gray-900">
                ...
                {/* <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 space-y-10">
                      <fieldset>
                        ...
                        <p className="mt-1 text-sm leading-6 text-gray-600">
                          Choose any of the payment method
                        </p>
              ...
              <div className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                ...
                <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                  <button
                    ...
                    type="button"
                    className="font-medium text-black-600 hover:text-green-500"
                  >
                    Edit
                  </button>
                  <button
